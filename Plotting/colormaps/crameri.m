...
%
% clear all
% f = {'acton','bamako','batlow','berlin','bilbao','broc','brocO','buda','cork',...
%    'corkO','davos','devon','grayC','hawaii','imola','lajolla','lapaz','lisbon',...
%    'nuuk','oleron','oslo','roma','romaO','tofino','tokyo','turku','vik','vikO'}; 
% 
% for k = 1:length(f)
%    load([f{k},'/',f{k},'.mat'])
% end
